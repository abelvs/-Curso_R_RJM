...
df <- read_excel("01_input/Ejemplo_2_incidencia_estatal_delitos_2015_2025_oct.xlsx") %>% 
  clean_names()

poblacion_conapo <- fread("01_input/00_Pob_Mitad_1950_2070.csv") %>% 
  clean_names() %>% 
  rename(ano = anio) %>% 
  filter(ano %in% (2015:2025)) %>% 
